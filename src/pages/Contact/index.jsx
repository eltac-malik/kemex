              ...
              <Form className={`w-96`}>
                <div className="mb-4">
                  <Field
                    ...
                    id="name"
                    placeholder=" Name"
                    className={`appearance-none border-b-2 w-full py-4 px-1 text-gray-800 leading-tight focus:outline-none focus:shadow-outline placeholder-gray-800  ${
                ...
                <div className="mb-4">
                  <Field
                    ...
                    id="email"
                    placeholder="Email"
                    className={`appearance-none border-b-2 w-full py-2 px-3 text-gray-800 leading-tight focus:outline-none focus:shadow-outline placeholder-gray-800  ${
                ...
                <button
                  type="submit"
                  className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded justify-end flex-1"
                >
                  Submit
                </button>
              </Form>
