...
export const Counter = () => {
  ...
  return (
    ...
    <section id={style['counter-stats']} className="wow fadeInRight" data-wow-duration="1.4s">
        <div className={style['counter-head']}>
            <h1>Counter head</h1>
            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Sed, temporibus dolorem? </p>
        </div>
	...
	<div className="container">
		<div className="row">
			...
			<div className="col-lg-3" id={style.stats}>
				...
				<div className="counting" data-count="999">0</div>
